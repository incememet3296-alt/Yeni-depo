...
export function CameraPage({ onNavigate }: CameraPageProps) {
  ...
  // Compass is optional on many Android devices/browsers. Keep the camera
  // discovery layer working with geographic north (0°) until a real heading
  // becomes available instead of hiding every animal.
